    ...
    if args.Gradient_descent_iteration ==-1  or args.Gradient_descent_iteration ==0 :
        ...
        for outer_loop in range(args.Gradient_descent_iteration):  # 循环
            ...
            if Best_loss > loss: # save the best model
                Best_net = net 
            print(acc,loss)
            if acc >0.99 and acc_iterations==0:  #记录训练到0.9准确率的周期
...
parser.add_argument('--Gradient_descent_iteration', default=50, type=int, help='the iterations of gradient tune')
